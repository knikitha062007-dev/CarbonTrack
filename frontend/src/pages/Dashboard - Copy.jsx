...
useEffect(() => {
  ...
  const handleEditActivity = (activity) => {
    ...
    setActivityForm({
      ...
      calcMode: "auto",
      manualValue: "",
      distance: activity.quantity,
      transportMode: activity.subType,
      hours: activity.quantity,
      appliance: activity.subType,
      mealType: activity.subType,
      shoppingCat: activity.subType,
      itemsCount: activity.quantity,
    });
      ...
      {isModalOpen && (
        <div className="modal-overlay" onClick={() => setIsModalOpen(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={editingId ? handleUpdateActivity : handleAddActivity}>
              <div className="form-group">
                <div className="form-group">
              ...
              <div className="modal-actions">
                ...
                <button type="submit" className="btn-primary">
                  {editingId ? "Update Acztivity" : "Append to Logs"}
                </button>
              </div>
            </form>
          </div>
